 <div class="row">
             ...
             <!--      @if(count($data->getPictures()->get()) > 0)
             @foreach($data->getPictures()->get() as $k=>$v)
             <li>
                 <a  href="optionallink.html">
                    <img class="etalage_thumb_image" src="{{asset("/.img/produk/client/". $data->foto )}}" />
                    <img class="etalage_source_image" src="{{asset("/.img/produk/client/". $data->foto )}}" />
                </a>
            </li>
            @endforeach
            @else
