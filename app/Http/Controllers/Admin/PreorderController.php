   ...
   public function index()
    {
        ...
        return view('vendor.backpack.base.preorder')->with('data',$data);
       //
    }
    public function tambah()
    {
        ...
        return view('vendor.backpack.base.tambahpo')->with(compact('kategori',$kategori,'ukuran',$ukuran,'metode',$metode));
       //
    }
